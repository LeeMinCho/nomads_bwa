                    ...
                    <div class="card card-details">
                        ...
                        <div class="attendee">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/frontend/images/Testimonial-1.png" width="60">
                                        </td>
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                ...
                                <input type="text" class="form-control mb-2 mr-sm-2" id="nationality" name="nationality" placeholder="Nationality" style="width: 50px;">
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <p class="payment-instructions">
                            Please Complete the payment before you continue the beautiful trip
                        </p>
                        <div class="bank">
